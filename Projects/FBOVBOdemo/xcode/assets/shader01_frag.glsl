...
void main(void){
    ...
    gl_FragColor = Perlin3D_Deriv( vec3(gl_FragCoord.x/resolution.x*3.5,gl_FragCoord.y/resolution.y*3.1, time*.1) ) - cnoise(vec2(gl_FragCoord.x/resolution.x*1.0,gl_FragCoord.y/resolution.y*1.0))*0.01    ;// noisePerlin;
...
//                        cnoise(vec2(gl_FragCoord.x/resolution.x*10.0,gl_FragCoord.y/resolution.y*10.0)),
//                        1.0);//, cnoise(vec2((gl_FragCoord.y/resolution.y),time*0.05*gl_FragCoord.x/resolution.x)), cnoise(vec2(gl_FragCoord.x/resolution.x*10.0,gl_FragCoord.y/resolution.y*10.0)), 1.0);
